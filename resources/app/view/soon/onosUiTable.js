...
(function () {
    ...
    // constants
    var detailsReq = 'onosUiTableDetailsRequest',
        detailsResp = 'onosUiTableDetailsResponse',
        pName = 'ov-onos-ui-table-item-details-panel',

        propOrder = ['id', 'businessType', 'srcNode','desNode','normal'],
        friendlyProps = ['Data ID', 'Business Type', 'Src Node','Des Node','Normal'];
    ...
    angular.module('ovOnosUiTable', [])
        .controller('OvOnosUiTableCtrl',
        ['$log', '$scope', 'TableBuilderService',
            ...
            function (_$log_, _$scope_, tbs, _fs_, _wss_) {
                ...
                $scope.$on('$destroy', function () {
                    ...
                    $log.log('OvOnosUiTableCtrl has been destroyed');
                });

                $log.log('OvOnosUiTableCtrl has been created');
            }])

        .directive('ovOnosUiTableItemDetailsPanel', ['PanelService', 'KeyService',
            function (ps, ks) {
            return {
                restrict: 'E',
